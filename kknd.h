...
enum __udec KKND::TaskMessageType : unsigned __int32
{
  ...
  TaskMessage_1513_sidebar = 1513u,
  TaskMessage_1514_sidebar = 1514u,
...
/* 178 */
typedef void (__cdecl __noreturn *KKND::TaskFn)(KKND::Task *task);
...
struct KKND::Task
{
  ...
  int (__fastcall *mode_turret)(int);
  int sleep;
  KKND::TaskKind kind;
...
struct KKND::CplcSpawnParams
{
  ...
  int player_side_or_stru49_array_idx;
  int spawn_param;
...
enum __dec KKND::TaskType : __int32
{
  ...
  TaskType_task_4269B0_mobd_20_handler = 122,
  TaskType_Max = 196,
  TaskType_Invalid = -1,
};
...
/// 1: query width
/// 2: query height
typedef int (__fastcall *KKND::Blitter)(KKND::RenderCommand *cmd, int mode);
...
/* 212 */
enum __dec KKND::GameState : unsigned __int32
{
...
enum KKND::TerrainTileFlags2 : unsigned __int8
{
  ...
  TerrainTileFlags2_FriendlyInfantrySlot0 = 0x1, ///< The XOR pattern (flags ^ flags2) & 0x1F is the key trick — it detects tiles where occupied slots don't match friendly slots, meaning enemy infantry is present.
  TerrainTileFlags2_FriendlyInfantrySlot1 = 0x2,
  TerrainTileFlags2_FriendlyInfantrySlot2 = 0x4,
  TerrainTileFlags2_FriendlyInfantrySlot3 = 0x8,
  TerrainTileFlags2_FriendlyInfantrySlot4 = 0x10,
...
/* 230 */
struct KKND::BuildingLevelsTracker
{
...
struct KKND::BuildingState
{
  ...
  KKND::BuildingStatusBar *status_bar;
  int _building_state_field_18_unused;
  int _building_state_field_1C_unused;
  int _building_state_field_20_unused;
  int _building_state_field_24_unused;
};

/* 279 */
struct __unaligned __declspec(align(2)) KKND::BuildingStatusBar
{
  int width;
  int height;
...
/* 288 */
struct KKND::BuildingsTracker
{
  KKND::BuildingsTracker *next;
  KKND::BuildingsTracker *prev;
  KKND::UnitType type;
...
/* 299 */
struct KKND::UiString
{
  KKND::UiString *next;
  KKND::UiString *prev;
  KKND::stru8 *pstru8;
  int _ui_string_field_C;
  int _ui_string_field_10;
  KKND::LevelMobdSurface *mobd_font__see_sub_405A60;
  int _ui_string_field_18;
  int num_lines;
};
...
struct KKND::AiController
{
  ...
  KKND::Unit *_ai_controller_8;
  KKND::AiController_struC *_ai_controller_C;
  KKND::Ai_stru10_Node *_ai_controller_10_pool;
  KKND::Ai_stru10_Node *_ai_controller_10_free;
  KKND::AiWandererNode *_ai_controller_18_head;
  KKND::AiWandererNode *_ai_controller_18_tail;
  int _ai_controller_20_ai_strategic_value_threshold;
  int _ai_controller_24;
  KKND::AiWandererNode *_ai_controller_28_pool;
  KKND::AiWandererNode *_ai_controller_28_free;
  KKND::AiWandererNode *_ai_controller_30_head;
  KKND::AiWandererNode *_ai_controller_30_tail;
  char _ai_controller_38[8];
  KKND::AiWandererNode *_ai_controller_40_pool;
  KKND::AiWandererNode *_ai_controller_40_free;
  KKND::AiAttackerNode *_ai_controller_58_head;
  KKND::AiAttackerNode *_ai_controller_58_tail;
  char _ai_controller_50[8];
  KKND::AiAttackerNode *_ai_controller_58_pool;
  KKND::AiAttackerNode *_ai_controller_58_free;
  KKND::AiAttackerNode *_ai_controller_60_head;
  KKND::AiAttackerNode *_ai_controller_60_tail;
  ...
  KKND::AiDrillrigNode *drillrig_free;
  ...
  KKND::AiPowerPlantNode *powerplant_free;
  ...
  KKND::AiDrillrigNode *_ai_controller_2E8;
  KKND::AiMobileDerrickNode *_ai_controller_2EC_head;
  KKND::AiMobileDerrickNode *_ai_controller_2EC_tail;
  char _ai_controller_2F4[28];
  KKND::AiMobileDerrickNode *_ai_controller_310;
  KKND::AiMobileDerrickNode *_ai_controller_314;
  KKND::AiMobileDerrickNode *_ai_controller_318_head;
  KKND::AiMobileDerrickNode *_ai_controller_318_tail;
  char _ai_controller_320[28];
  int _ai_controller_33C;
  int _ai_controller_340;
  int _ai_controller_344;
  int _ai_controller_348_base_cost;
  int _ai_controller_34C_remaining_cost;
  int _ai_controller_350;
  int _ai_controller_354;
  KKND::Task *_ai_controller_358_unit_task;
...
struct KKND::Ai_stru160_Node
{
  ...
  int _ai_stru160_node_28;
  int _ai_stru160_node_2C_ai_threat_weight_total;
  int _ai_stru160_node_30_threat_in_area;
  int _ai_stru160_node_34_x;
  int _ai_stru160_node_38_y;
  int _ai_stru160_node_3C;
  int _ai_stru160_node_40;
};
...
struct KKND::AiMobileDerrickNode
{
  KKND::AiMobileDerrickNode *next;
  KKND::AiMobileDerrickNode *prev;
  KKND::Unit *unit;
  KKND::UnitType unit_type;
  int _ai_stru310_node_10_unit_x;
  int _ai_stru310_node_14_unit_y;
  int _ai_stru310_node_18_unit_grid_anchor_x;
  int _ai_stru310_node_1C_unit_grid_anchor_y;
  int _ai_stru310_node_20_unit_ai_strategic_value;
};

/* 309 */
/// AiWandererNode
struct KKND::Ai_stru40_Node
{
  KKND::AiWandererNode *next;
  KKND::AiWandererNode *prev;
  int _ai_wanderer_node_8;
...
{
  KKND::TaskType creature_id __dec;     ///< actually offset into scripts fn table
...
/* 323 */
struct KKND::SidebarPayload
{
  void (__fastcall *mode)(KKND::SidebarPayload *);
  int _sidebar_payload_4;
  KKND::Entity *_sidebar_payload_8;
  KKND::Entity *airstrike_button_entity;
  KKND::Task *task;
};
...
struct KKND::MovieHeader
{
  ...
  __int16 _movie_header_E;
  int _movie_header_10;
  int sound_samples_per_sec;
  int sound_flags;
  int sound_bytes_num;
  __int16 *sound_bytes;
  int _movie_header_28_str_len;
  const char *_movie_header_28_str;
};

/* 342 */
struct __unaligned KKND::MovieFrame
{
  int size;
  __int16 _movie_frame_4;
